...
export const SidebarLink = ({
  ...
  return (
    <Link
      href={link.href}
      className={cn(
        "flex items-center justify-start gap-2 text-[#E9EFEC] group/sidebar py-2",
        className
      )}
      onClick={onClick} 
      {...props}
    >
      ...
      <motion.span
        ...
        className="text-[#E9EFEC] font-semibold text-lg dark:text-neutral-200 group-hover/sidebar:translate-x-1 transition duration-150 whitespace-pre inline-block !p-0 !m-0"
      >
        {link.label}
      </motion.span>
    </Link>
