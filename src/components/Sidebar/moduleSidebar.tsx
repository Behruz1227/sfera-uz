...
const ModuleSidebar: React.FC<ModuleSidebarProps> = ({ modules, lessons }) => {
  ...
  useEffect(() => {
    if (initialLoadDone || selectedLessonId) getData();
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "w-full mb-20 px-4 py-4 flex lg:hidden md:flex-col bg-[#16423C] text-[#E9EFEC] shadow-lg"
        )}
      >
        <div className="flex relative flex-col flex-1 overflow-y-auto overflow-x-hidden">
          {/* <Meteors number={30} /> */}
